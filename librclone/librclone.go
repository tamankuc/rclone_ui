...
//
//	go build --buildmode=c-shared -o librclone.so github.com/tamankuc/rclone_ui/librclone
//
// Build a static library like this:
//
//	go build --buildmode=c-archive -o librclone.a github.com/tamankuc/rclone_ui/librclone
//
...
import (
	...
	"github.com/tamankuc/rclone_ui/librclone/librclone"

	_ "github.com/tamankuc/rclone_ui/backend/all"   // import all backends
	_ "github.com/tamankuc/rclone_ui/cmd/cmount"    // import cmount
	_ "github.com/tamankuc/rclone_ui/cmd/mount"     // import mount
	_ "github.com/tamankuc/rclone_ui/cmd/mount2"    // import mount2
	_ "github.com/tamankuc/rclone_ui/fs/operations" // import operations/* rc commands
	_ "github.com/tamankuc/rclone_ui/fs/sync"       // import sync/*
