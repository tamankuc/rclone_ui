...
<tr><th>Branch</th><td><a href="https://github.com/tamankuc/rclone_ui/tree/{{ .Branch }}">{{ .Branch }}</a></td></tr>
{{ if .Commit}}<tr><th>Commit</th><td><a href="https://github.com/tamankuc/rclone_ui/commit/{{ .Commit }}">{{ .Commit }}</a></td></tr>{{ end }}
