...
import (
	...
	"github.com/tamankuc/rclone_ui/vfs/vfscache/downloaders"
	"github.com/tamankuc/rclone_ui/vfs/vfscache/writeback"
)
...
func (item *Item) _ensure(offset, size int64) (err error) {
	...
	if item.downloaders == nil {
		...
		// See: https://github.com/tamankuc/rclone_ui/issues/6190
		// See: https://github.com/tamankuc/rclone_ui/issues/6235
		if item.o == nil {
